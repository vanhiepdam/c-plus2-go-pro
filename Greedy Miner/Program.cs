...
class GreedyMiner
{
    ...
    public static void generate1(List<Block> c1, int c2, int c3) // c2 + c3 is points ------- 30% value = coal(1) 50% value = 0 hardness = 1 10% value = 0 hardness = 2
    {
        ...
        else if (localRandSet > 3 && localRandSet < 10)
        {
    ...
    public static void generate2(List<Block> c1, int c2, int c3) // c2 + c3 is points ------- 14% value = coal(1) 24% value = iron(2) 2% value = gold(3) 28% value = 0 hardness = 1 32% value = 0 hardness = 2
    {
        int localRandSet = rand.Next(1, 51);
        if (localRandSet > 0 && localRandSet < 8)
        {
            c1.Add(new Block(1, coalValue, c2, c3));
        }
        else if (localRandSet > 7 && localRandSet < 20)
        {
            c1.Add(new Block(1, ironValue, c2, c3));
        }
        else if (localRandSet > 19 && localRandSet < 21)
        {
            c1.Add(new Block(1, goldValue, c2, c3));
        }
        else if (localRandSet > 20 && localRandSet < 35)
        {
            c1.Add(new Block(1, 0, c2, c3));
        }
        else if (localRandSet > 34 && localRandSet < 51)
        {
            c1.Add(new Block(2, 0, c2, c3));
        }
    ...
    public static void generate3(List<Block> c1, int c2, int c3) // c2 + c3 is points ------- 5% value = coal(1) 10% value = iron(2) 5% value = gold(3) 10% value = 0 hardness = 2 65% value = 0 hardness = 2 5% value = 0 hardness = 3
    {
        int localRandSet = rand.Next(1, 21);
        if (localRandSet > 0 && localRandSet < 2)
        {
            c1.Add(new Block(1, coalValue, c2, c3));
        }
        else if (localRandSet > 1 && localRandSet < 4)
        {
            c1.Add(new Block(1, ironValue, c2, c3));
        }
        else if (localRandSet > 3 && localRandSet < 5)
        {
            c1.Add(new Block(1, goldValue, c2, c3));
        }
        else if (localRandSet > 4 && localRandSet < 7)
        {
            c1.Add(new Block(1, 0, c2, c3));
        }
        else if (localRandSet > 6 && localRandSet < 20)
        {
            c1.Add(new Block(2, 0, c2, c3));
        }
        else if (localRandSet > 19 && localRandSet < 21)
    ...
    static void Main()
    {
        ...
        while (reset) {
            ...
            Console.ForegroundColor = ConsoleColor.DarkGreen;
            Console.WriteLine("Turn left: {0}", John.getTurn());
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine("Player Score: {0}", playerScore);
            Console.WriteLine("Highscore : {0}", playerHighScore);
            //
            ...
            while (John.getTurn() > 0)
            {
                ...
                if (keypress == ConsoleKey.DownArrow)
                {
                    if (John.getBodyX() != mapLength - 1)
                    {
                        if (Map.Single(p => p.getX() == John.getBodyX() + 1 && p.getY() == John.getBodyY()).getValue() > 0)
                        {
                            ...
                            playerScore += Map.Single(p => p.getX() == John.getBodyX() + 1 && p.getY() == John.getBodyY()).getValue();
                    ...
                    if (John.getHeadY() != 0)
                    {
                        if (Map.Single(p => p.getX() == John.getHeadX() && p.getY() == John.getHeadY() - 1).getHardness() > 0)
                        {
                            ...
                            if (Map.Single(p => p.getX() == John.getHeadX() && p.getY() == John.getHeadY() - 1).getValue() > 0)
                            {
                                ...
                                playerScore += Map.Single(p => p.getX() == John.getHeadX() && p.getY() == John.getHeadY() - 1).getValue();
                        ...
                        else if (Map.Single(p => p.getX() == John.getBodyX() && p.getY() == John.getBodyY() - 1).getHardness() > 0)
                        {
                            ...
                            if (Map.Single(p => p.getX() == John.getBodyX() && p.getY() == John.getBodyY() - 1).getValue() > 0)
                            {
                                ...
                                playerScore += Map.Single(p => p.getX() == John.getBodyX() && p.getY() == John.getBodyY() - 1).getValue();
                ...
                {
                    if (Map.Single(p => p.getX() == John.getHeadX() - 1 && p.getY() == John.getHeadY()).getHardness() > 0)
                    {
                        John.reduceTurn();
                        Map.Single(p => p.getX() == John.getHeadX() - 1 && p.getY() == John.getHeadY()).reduceHardness();
                        if (Map.Single(p => p.getX() == John.getHeadX() - 1 && p.getY() == John.getHeadY()).getValue() > 0)
                        {
                            John.increseTurn(Map.Single(p => p.getX() == John.getHeadX() - 1 && p.getY() == John.getHeadY()).getValue());
                            playerScore += Map.Single(p => p.getX() == John.getHeadX() - 1 && p.getY() == John.getHeadY()).getValue();
                            Map.Single(p => p.getX() == John.getHeadX() - 1 && p.getY() == John.getHeadY()).setValue(0);
                        }
                    }
                    Console.Clear();
                    // UPDATE MAP
            ...
            if (readline == "y")
            {
                string playerHighScoreString = playerHighScore.ToString();
                System.IO.File.WriteAllText(Application.StartupPath + "/data.txt", playerHighScoreString);
                reset = true;
            }
            else
            {
